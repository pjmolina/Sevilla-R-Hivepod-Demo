angular.module('myApp').controller('ListOficinaController', 
  ['$http', '$scope', '$location', '$q', '$timeout', '$modal', 'SecurityService', 'NavigationService', 'EntityUtilService', 'OficinaService', 
  function($http, $scope, $location, $q, $timeout, $modal, SecurityService, NavigationService, EntityUtilService, OficinaService) {
	...
	$scope.add = function () {
		$location.path('/oficina/add');
	};

	$scope.edit = function (obj) {
		$location.path('/oficina/edit/' + obj._id);
	};
	$scope.view = function (obj) {
		$location.path('/oficina/view/' + obj._id);
	};
	$scope.delete = function (obj) {
		$location.path('/oficina/delete/' + obj._id);
	};
	...
	function doDeleteByQuery() {
		...
		return EntityUtilService.deleteByQuery(OficinaService, searchCriteria, $scope.refresh);  		
	}
	...
	function doDeleteSelected() {
		EntityUtilService.deleteSelected(OficinaService, $scope.dataList, $scope.refresh);  
	}
	...
	function init() {
		SecurityService.getPermisionsFoResource('oficina').then(function(httpData) {
