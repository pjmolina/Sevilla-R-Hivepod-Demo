angular.module('myApp').controller('ListWeatherController', 
  ['$http', '$scope', '$location', '$q', '$timeout', '$modal', 'SecurityService', 'NavigationService', 'EntityUtilService', 'WeatherService', 
  function($http, $scope, $location, $q, $timeout, $modal, SecurityService, NavigationService, EntityUtilService, WeatherService) {
	...
	$scope.view = function (obj) {
		$location.path('/weather/view/' + obj._id);
	};
	...
	function doDeleteByQuery() {
		...
		return EntityUtilService.deleteByQuery(WeatherService, searchCriteria, $scope.refresh);  		
	}
	...
	function doDeleteSelected() {
		EntityUtilService.deleteSelected(WeatherService, $scope.dataList, $scope.refresh);  
	}
	...
	function init() {
		SecurityService.getPermisionsFoResource('weather').then(function(httpData) {
