angular.module('myApp').controller('SelectOlympicMedalController', ['$http', '$scope', '$location', '$translate', '$q', '$timeout', 'NavigationService', 'EntityUtilService', 'OlympicMedalService', function($http, $scope, $location, $translate, $q, $timeout, NavigationService, EntityUtilService, OlympicMedalService) {
