angular.module('myApp').controller('ListOlympicMedalController', 
  ['$http', '$scope', '$location', '$q', '$timeout', '$modal', 'SecurityService', 'NavigationService', 'EntityUtilService', 'OlympicMedalService', 
  function($http, $scope, $location, $q, $timeout, $modal, SecurityService, NavigationService, EntityUtilService, OlympicMedalService) {
	...
	$scope.view = function (obj) {
		$location.path('/olympicMedal/view/' + obj._id);
	};
	...
	function doDeleteByQuery() {
		...
		return EntityUtilService.deleteByQuery(OlympicMedalService, searchCriteria, $scope.refresh);  		
	}
	...
	function doDeleteSelected() {
		EntityUtilService.deleteSelected(OlympicMedalService, $scope.dataList, $scope.refresh);  
	}
	...
	$scope.exportAs = function (format) { 
		EntityUtilService.exportAsFormat(
			...
			OlympicMedalService, "olympicMedals", $scope);
		$scope.ui.dropdown.isOpen = false;
	};
	//-----------------------------
	...
	function init() {
		SecurityService.getPermisionsFoResource('olympicMedal').then(function(httpData) {
